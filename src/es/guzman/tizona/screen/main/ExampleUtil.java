...
public final class ExampleUtil {
    ...
    private static final String[] iso3166 = new String[] { "AFGHANISTAN", "AF",
            "��LAND ISLANDS", "AX", "ALBANIA", "AL", "ALGERIA", "DZ",
            ...
            "SAINT BARTH��LEMY", "BL", "SAINT HELENA", "SH",
    ...
    public static IndexedContainer getNameContainer() {
        IndexedContainer contactContainer = new IndexedContainer();
        contactContainer.addContainerProperty(PERSON_PROPERTY_NAME,
                String.class, "");
        ...
        for (int i = 0; i < 50;) {
            ...
            if (item != null) {
                i++;
                item.getItemProperty(PERSON_PROPERTY_NAME).setValue(
                        fn + " " + ln);
            }
        }
        return contactContainer;
    ...
    public static IndexedContainer getTimeZoneContainer() {
        IndexedContainer localeContainer = new IndexedContainer();
        localeContainer.addContainerProperty(timezone_PROPERTY_TIME_ZONE,
                TimeZone.class, null);
        localeContainer.addContainerProperty(timezone_PROPERTY_NAME,
                String.class, null);
        for (int i = 0; i < timezones.length; i++) {
            String id = timezones[i];
            Item item = localeContainer.addItem(id);
            TimeZone timeZone = TimeZone.getTimeZone(id);
            item.getItemProperty(timezone_PROPERTY_TIME_ZONE)
                    .setValue(timeZone);
            item.getItemProperty(timezone_PROPERTY_NAME).setValue(
